    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="../Empresa.php" class="dropdown-toggle"><i class="menu-icon fa fa-suitcase"></i>Empresa</a>
                </li>
                <li>
                    <a href="../Camion.php" class="dropdown-toggle"><i class="menu-icon fa fa-truck"></i>Camión</a>
                </li>
                <li>
                    <a href="../Ruta.php" class="dropdown-toggle"><i class="menu-icon fa fa-cogs"></i>Ruta</a>
                </li>
                <li>
                    <a href="../Servicio.php" class="dropdown-toggle"><i class="menu-icon fa fa-calendar"></i>Servicio</a>
                </li>
                <li>
