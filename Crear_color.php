        ...
        <div class="animated fadeIn">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <strong class="card-title">Añadir un nuevo color</strong>
                ...
                <div class="card-body">
                    ...
                    <div class="fontawesome-icon-list">
                        ...
                        <form method="POST">
                            ...
                            <label class="label"> Nombre del color:
                            ...
                            <br>
                            <a href="Color.php" class="btn btn-success btn-flat m-b-30 m-t-30" id="Guardar"
                                    ">Atrás
                            </a>
                            <button class="btn btn-success btn-flat m-b-30 m-t-30" name="Guardar"
                                    type="Guardar">Guardar
                            </button>
                            <br>
                        </form>
